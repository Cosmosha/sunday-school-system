...
class ModelStudents{
    ...
    static public function mdlAddStudent($table, $data){
        ...
        $stmt = Connection::connect()->prepare("INSERT INTO $table(student_firstname, student_lastname, gender, dob, student_level, class_form, school_name, region_id, guardian_name, phone, home_address, class_id, church_id)
        VALUE(:student_firstname, :student_lastname, :gender, :dob, :student_level, :class_form, :school_name, :region_id, :guardian_name, :phone, :home_address, :class_id, :church_id)");
        ...
        $stmt->bindParam(":region_id", $data["region_id"], PDO::PARAM_STR);
